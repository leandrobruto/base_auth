        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">GamePlan</span>
            </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?= userLoggedIn()->name; ?></span>
                ...
                <?php if (session()->has('success')): ?>
                  <div class="col-lg-12 mb-2 order-0">
                    <div class="alert alert-success alert-dismissible" role="alert">
                      <strong>Perfect!</strong> <?= session('success'); ?>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://www.instagram.com/le.andru/" target="_blank" class="footer-link fw-bolder">Cordylus</a>
                </div>
                <div>
                  <a href="https://www.instagram.com/le.andru/" class="footer-link me-4" target="_blank">License</a>
                  <a href="https://www.instagram.com/le.andru/" target="_blank" class="footer-link me-4">More Themes</a>

                  <a
                    href="https://www.instagram.com/le.andru/"
                    target="_blank"
