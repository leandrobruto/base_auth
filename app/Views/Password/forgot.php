        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (session()->has('success')): ?>
                    ...
                    <strong>Perfeito!</strong> <?= session('success'); ?>
                ...
                <?= form_open('password/processForgot'); ?>
                    ...
                    <div class="mb-3">
                        <input id="btn-reset-password" type="submit" value="Send Reset Link" class="btn btn-primary d-grid w-100" />
                    </div>
                <?= form_close(); ?>
...
$("form").submit(function () {
    ...
    $("#btn-reset-password").val("Sending recovery email..");
});
